...
export function TopBar() {
  return (
    <header className="flex-shrink-0 flex items-center gap-3 px-6 py-[11px] bg-white border-b border-chimge-line">
      <label className="flex items-center gap-2.5 flex-1 max-w-[420px] px-3.5 py-2.5 rounded-xl border border-chimge-line bg-chimge-bg cursor-text">
        <Search size={16} className="text-chimge-ink-3 flex-shrink-0" />
